...
class AWSLambdaService:
    ...
    def deploy_lambda_function(self, function_name, ls_files, env_vari, handler, description, timeout = 300, memorysize = 128):
        ...
        try:
            response = self.client.create_function(
                ...
                Publish=True,
                Role='arn:aws:iam::737589818430:role/role_lambda_to_cloudwatch_cognito_DB',
                Runtime='python3.8',
                Tags={
                    'DEPARTMENT': 'Assets',
                },
            ...
            self.client.get_waiter('function_active').wait(
                        FunctionName=function_name
                    )
            ...
            if err.response['Error']['Code'] == 'ResourceConflictException' and 'Function already exist' in err.response['Error']['Message']:
                try:
