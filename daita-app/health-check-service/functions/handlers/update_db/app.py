...
class UpdateDBClass(LambdaBaseClass):
    ...
    def __init__(self) -> None:
        ...
        self.healcheck_model = HealthCheckInfoModel(
    ...
    def handle(self, event, context):
        ...
        healthcheck_id = self.healcheck_model.create_new_healthcheck_info(
            self.healthcheck, self.project_id, self.data_type
        )

        ### update healthcheck_id to data DB and
        self.data_model.update_healthcheck_id(
            self.project_id, self.healthcheck["file_name"], healthcheck_id
        )
