...
class HealthCheckClass(LambdaBaseClass):
    def __init__(self) -> None:
        ...
        self.health_check_model = HealthCheckTaskModel(
            os.environ["TABLE_HEALTHCHECK_TASK"]
        )
    ...
    def _create_task(self, identity_id, project_id, data_type):
        # create task id
        task_id, process_type = self.health_check_model.create_new_healthcheck_task(
            identity_id, project_id, data_type
        )
    ...
    def handle(self, event, context):
        ...
        task_id, process_type = self._create_task(
            identity_id, self.project_id, self.data_type
        )
