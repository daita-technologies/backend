...
class ApplyParamExpertModeClass(LambdaBaseClass):
    ...
    def _update_generate_expert_mode_param(
        self,
        identity_id,
        project_name,
        times_augment,
        ...
        self.project_model.update_generate_expert_mode_param(
            identity_id, project_name, reference_images, aug_params
        )
    ...
    def handle(self, event, context):
        ...
        self._update_generate_expert_mode_param(
            identity_id, self.project_name, self.reference_images, self.aug_parameters
        )
