        ...
        for method_info in data:
            ...
            for idx, value in enumerate(ls_aug_img):
                ...
                for param_name_idx in ls_param_name:
                    ...
                    str_key.append(
                        str(ls_param_value[param_name_idx].index(value_param))
                    )
                key = "|".join(str_key)
                method_info["dict_aug_img"][key] = generate_presigned_url(
                    value["aug_review_img"]
                )
            ...
            for method, ls_value in ls_param_value.items():
                ...
                method_info["ls_param_info"][method] = {"step": step, "type": type}
