...
class ProjectModel:
    ...
    def update_project_generate_times(
        self,
        identity_id,
        project_name,
        times_augment,
    ...
    def update_generate_expert_mode_param(
        self, identity_id, project_name, reference_images, aug_params
    ):
        response = self.table.update_item(
            Key={
                ProjectItem.FIELD_IDENTITY_ID: identity_id,
    ...
    def update_project_reference_images(
        self, identity_id, project_name, reference_images
    ):
        """
