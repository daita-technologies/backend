...
def deploy_lambda_auth(general_info, lambda_service):
    ...
    add_lambda_info_to_list(ls_lambda_val, lambda_uri,
                            lambda_version, 'auth', 'user_logout')
    # # login
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(f'login',
                                                                       ...
                                                                       'staging: login')
    add_lambda_info_to_list(ls_lambda_val, lambda_uri,
                            lambda_version, 'auth', 'user_login')
    ...
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(f'user_signup',
                                                                       ...
                                                                       'staging: register')
    add_lambda_info_to_list(ls_lambda_val, lambda_uri,
                            lambda_version, 'auth', 'user_signup')
    ...
    add_lambda_info_to_list(ls_lambda_val, lambda_uri,
                            lambda_version, 'auth', 'login_social')
    # Credential
    ...
    add_lambda_info_to_list(ls_lambda_val, lambda_uri,
                            lambda_version, 'auth', 'credential')
    # template email
    ...
    add_lambda_info_to_list(ls_lambda_val, lambda_uri,
                            lambda_version, 'auth', 'template-invite-mail')
    ...
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(f'resend_confirmcode',
                                                                       ...
                                                                       'staging: template_mail')
    add_lambda_info_to_list(ls_lambda_val, lambda_uri,
                            lambda_version, 'auth', 'resend_confirmcode')
    ...
    add_lambda_info_to_list(ls_lambda_val, lambda_uri,
                            lambda_version, 'auth', 'auth_confirm')
    ...
    add_lambda_info_to_list(ls_lambda_val, lambda_uri,
                            lambda_version, 'auth', 'forgot_password')
    ...
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(f'staging-confirm-code-forgot-password',
                                                                       [
                                                                           CODE_DIR.joinpath(
                                                                               "confirm_code_forgot_password.py"),
                                                                           PROJECT_DIR.joinpath(
                                                                               "packages"),
                                                                           PROJECT_DIR.joinpath(
                                                                               "common")
    ...
    add_lambda_info_to_list(ls_lambda_val, lambda_uri,
                            lambda_version, 'auth', 'confirm_code_forgot_password')
    ...
    add_lambda_info_to_list(ls_lambda_val, lambda_uri,
                            lambda_version, 'auth', 'refresh_token')
    ...
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(f'staging-github-openid-token-wrapper',
                                                                       ls_files=[
                                                                           CODE_DIR.joinpath(
                                                                               "github_openid_token_wrapper.py"),
                                                                           PROJECT_DIR.joinpath(
                                                                               "common"),
                                                                           PROJECT_DIR.joinpath(
                                                                               "packages"),
    ...
    add_lambda_info_to_list(ls_lambda_val, lambda_uri,
                            lambda_version, 'auth', 'github-openid-token-wrapper')
    ...
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(f'staging-github-openid-userinfo-wrapper',
                                                                       ls_files=[
                                                                           CODE_DIR.joinpath(
                                                                               "github_openid_userinfo_wrapper.py"),
                                                                           PROJECT_DIR.joinpath(
                                                                               "common"),
                                                                           PROJECT_DIR.joinpath(
                                                                               "packages"),
    ...
    add_lambda_info_to_list(ls_lambda_val, lambda_uri,
                            lambda_version, 'auth', 'github-openid-userinfo-wrapper')
