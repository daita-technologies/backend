CLIENTPOOLID = "7v8h65t0d3elscfqll090acf9h"
USERPOOLID = "us-east-2_6Sc8AZij7"
REGION = "us-east-2"
IDENTITYPOOLID = "us-east-2:639788f0-a9b0-460d-9f50-23bbe5bc7140"
...
LOCATION = {'dev':"https://dev.daita.tech/"}
ENDPPOINTREDIRCTLOGINSOCIALOAUTH= {'dev':'https://yf6ayuvru1.execute-api.us-east-2.amazonaws.com/dev/auth/login_social'}
OAUTHENPOINT={'dev':'https://daitasociallogin.auth.us-east-2.amazoncognito.com/oauth2/token'}