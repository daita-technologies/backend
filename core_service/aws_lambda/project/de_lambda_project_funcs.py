...
def deploy_lambda_project(general_info, lambda_service):
    ...
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-project-create",
        [ROOT + "project_create.py", ROOT + "utils.py", ROOT + "const.py"],
        {
    ...
    add_lambda_info_to_list(
        ls_lambda_val, lambda_uri, lambda_version, "project", "create"
    )

    # create sample project passenger
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-project-create-sample",
        [ROOT + "project_sample.py", ROOT + "utils.py", ROOT + "const.py"],
        {
            "USER_POOL_ID": general_info["USER_POOL_ID"],
            "IDENTITY_POOL_ID": general_info["IDENTITY_POOL_ID"],
            "BUCKET_NAME": general_info["BUCKET_NAME"],
    ...
    add_lambda_info_to_list(
        ls_lambda_val, lambda_uri, lambda_version, "project", "create_sample"
    )

    # create sample project async
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-project-asy-create-sample",
        [ROOT + "project_asy_create_sameple.py", ROOT + "utils.py", ROOT + "const.py"],
        {
            "USER_POOL_ID": general_info["USER_POOL_ID"],
            "IDENTITY_POOL_ID": general_info["IDENTITY_POOL_ID"],
            "BUCKET_NAME": general_info["BUCKET_NAME"],
    ...
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-project-project-delete-image",
        [ROOT + "project_delete_images.py", ROOT + "utils.py", ROOT + "const.py"],
        {
            "USER_POOL_ID": general_info["USER_POOL_ID"],
            "IDENTITY_POOL_ID": general_info["IDENTITY_POOL_ID"],
            "BUCKET_NAME": general_info["BUCKET_NAME"],
    ...
    add_lambda_info_to_list(
        ls_lambda_val, lambda_uri, lambda_version, "project", "delete_images"
    )

    # delete project
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-project-project-delete",
        [ROOT + "project_delete_project.py", ROOT + "utils.py", ROOT + "const.py"],
        {
            "USER_POOL_ID": general_info["USER_POOL_ID"],
            "IDENTITY_POOL_ID": general_info["IDENTITY_POOL_ID"],
            "BUCKET_NAME": general_info["BUCKET_NAME"],
    ...
    add_lambda_info_to_list(
        ls_lambda_val, lambda_uri, lambda_version, "project", "delete"
    )

    # update project info: project_name, description
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-project-update-info",
        [ROOT + "project_update_info.py", ROOT + "utils.py", ROOT + "const.py"],
        {
            "USER_POOL_ID": general_info["USER_POOL_ID"],
            "IDENTITY_POOL_ID": general_info["IDENTITY_POOL_ID"],
            "T_PROJECT_SUMMARY": general_info["T_PROJECT_SUMMARY"],
    ...
    add_lambda_info_to_list(
        ls_lambda_val, lambda_uri, lambda_version, "project", "update_info"
    )

    # get project info
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-project-info",
        [ROOT + "project_info.py", ROOT + "utils.py", ROOT + "const.py"],
        {
            "USER_POOL_ID": general_info["USER_POOL_ID"],
            "IDENTITY_POOL_ID": general_info["IDENTITY_POOL_ID"],
            "T_PROJECT_SUMMARY": general_info["T_PROJECT_SUMMARY"],
    ...
    add_lambda_info_to_list(
        ls_lambda_val, lambda_uri, lambda_version, "project", "info"
    )

    # get project list
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-project-list",
        [ROOT + "project_list.py", ROOT + "utils.py", ROOT + "const.py"],
        {
            "USER_POOL_ID": general_info["USER_POOL_ID"],
            "IDENTITY_POOL_ID": general_info["IDENTITY_POOL_ID"],
            "T_PROJECT": general_info["T_PROJECT"],
    ...
    add_lambda_info_to_list(
        ls_lambda_val, lambda_uri, lambda_version, "project", "list"
    )

    # get list info: get all project and infor of them
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-project-list-info",
        [ROOT + "project_list_info.py", ROOT + "utils.py", ROOT + "const.py"],
        {
            "USER_POOL_ID": general_info["USER_POOL_ID"],
            "IDENTITY_POOL_ID": general_info["IDENTITY_POOL_ID"],
            "T_PROJECT": general_info["T_PROJECT"],
    ...
    add_lambda_info_to_list(
        ls_lambda_val, lambda_uri, lambda_version, "project", "list_info"
    )

    # check existen of file in S3 when upload image for project
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-project-upload-check",
        [ROOT + "project_upload_check.py", ROOT + "utils.py", ROOT + "const.py"],
        {
            "USER_POOL_ID": general_info["USER_POOL_ID"],
            "IDENTITY_POOL_ID": general_info["IDENTITY_POOL_ID"],
            "T_DATA_ORI": general_info["T_DATA_ORI"],
    ...
    add_lambda_info_to_list(
        ls_lambda_val, lambda_uri, lambda_version, "project", "upload_check"
    )

    # update info from client after finish uploading to S3
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-project-upload-update",
        [ROOT + "project_upload_update.py", ROOT + "utils.py", ROOT + "const.py"],
        {
            "USER_POOL_ID": general_info["USER_POOL_ID"],
            "IDENTITY_POOL_ID": general_info["IDENTITY_POOL_ID"],
            "T_PROJECT_SUMMARY": general_info["T_PROJECT_SUMMARY"],
    ...
    add_lambda_info_to_list(
        ls_lambda_val, lambda_uri, lambda_version, "project", "upload_update"
    )

    # create a download task
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-project-download-create",
        [
            ROOT + "project_download_create.py",
            ROOT + "utils.py",
            PACKAGES,
            ROOT + "const.py",
        ],
    ...
    add_lambda_info_to_list(
        ls_lambda_val, lambda_uri, lambda_version, "project", "download_create"
    )

    # get progress of downloading task
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-project-download-update",
        [ROOT + "project_download_update.py", ROOT + "utils.py", ROOT + "const.py"],
        {
            "USER_POOL_ID": general_info["USER_POOL_ID"],
            "IDENTITY_POOL_ID": general_info["IDENTITY_POOL_ID"],
            "T_PROJECT_SUMMARY": general_info["T_PROJECT_SUMMARY"],
    ...
    add_lambda_info_to_list(
        ls_lambda_val, lambda_uri, lambda_version, "project", "download_update"
    )

    # get list data s3_key in the DB, client will use it for downloading
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-project-list-data",
        [ROOT + "project_list_data.py", ROOT + "utils.py", ROOT + "const.py"],
        {
            "USER_POOL_ID": general_info["USER_POOL_ID"],
            "IDENTITY_POOL_ID": general_info["IDENTITY_POOL_ID"],
            "T_DATA_ORI": general_info["T_DATA_ORI"],
    ...
    add_lambda_info_to_list(
        ls_lambda_val, lambda_uri, lambda_version, "project", "list_data"
    )
