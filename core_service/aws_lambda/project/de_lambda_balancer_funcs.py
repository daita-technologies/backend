...
def deploy_lambda_balancer(general_info, lambda_service):
    ...
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-balancer-asy-start-test",
        [
            ROOT + "balancer_asy_start.py",
            ROOT + "utils.py",
    ...
    # async stop ec2
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-balancer-asy-stop",
        [
            ROOT + "balancer_asy_stop.py",
            ROOT + "utils.py",
            ROOT + "balancer_utils.py",
            ROOT + "const.py",
        ],
    ...
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-balancer-asy-get-ip",
        [
            ROOT + "balancer_asy_get_ip.py",
            ROOT + "utils.py",
            ROOT + "balancer_utils.py",
            ROOT + "const.py",
        ],
    ...
    # async get ip ec2 of user_id
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-balancer-asy-register",
        [
            ROOT + "balancer_asy_register_ec2.py",
            ROOT + "utils.py",
            ROOT + "balancer_utils.py",
            ROOT + "const.py",
        ],
    ...
    lambda_uri, lambda_version = lambda_service.deploy_lambda_function(
        f"staging-balancer-asy-finish-task",
        [
            ROOT + "balancer_asy_finish_task.py",
            ROOT + "utils.py",
            ROOT + "balancer_utils.py",
            ROOT + "const.py",
        ],
