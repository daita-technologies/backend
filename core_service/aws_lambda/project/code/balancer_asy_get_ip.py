...
def lambda_handler(event, context):
    ...
    try:
        ...
        ec2_info = {"ec2_id": ec2_id, "ip": instance.public_ip_address}
        ...
        # update public ip again
        instance.load()
        ec2_info["ip"] = instance.public_ip_address
    ...
    return convert_response(
        {"data": ec2_info, "error": False, "success": True, "message": None}
    )
