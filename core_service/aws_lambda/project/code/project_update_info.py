...
def lambda_handler(event, context):
    ...
    try:
        ...
        res_project = table.get_item(
            Key={"identity_id": identity_id, "project_name": project_name}
        )
        if res_project.get("Item", None):
            ...
            if len(new_prj_name) > 0:
                ...
                table.update_item(
                    ...
                    ExpressionAttributeValues={":de": new_description},
