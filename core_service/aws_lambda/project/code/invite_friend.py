...
def lambda_handler(event, context):
    ...
    print("send mail")
    message_email ="<p>Hi,</p><p>{} has invited you to explore DAITA's recently launched <a href='https://app.daita.tech'>data augmentation platform</a>.</p> <p>Building a platform that machine learning engineers and data scientists really love is truly hard. But that's our ultimate ambition!</p> <p>Thus, your feedback is greatly appreciated, as this first version will still be buggy and missing many features. Please send all your thoughts, concerns, feature requests, etc. to <a href=\"mailto:contact@daita.tech?subject=DAITA%20Platform%20User%20Feedback\"\>contact@daita.tech</a> or simply reply to this e-mail. Please be assured that all your feedback will find its way into our product backlog.</p> <p>All our services are currently free of charge - so you can go wild! Try it now <a href='https://app.daita.tech'>here</a>.</p> <p>Cheers,</p> <p>The DAITA Team</p>".format(email_name)
    try:
